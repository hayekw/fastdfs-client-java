...
class StorageClientInternal {
     ...
     */
    public StorageClientInternal(TrackerServer trackerServer) {
     ...
     */
    public StorageClientInternal(TrackerServer trackerServer, StorageServer storageServer) {
        this.trackerServer = trackerServer;
