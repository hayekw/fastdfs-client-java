 ...
 */
public class StorageClient extends StorageClientInternal {
     ...
     * return null if fail
     */
    public String uploadFile(String group_name, String local_filename, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
     ...
     * return null if fail
     */
    public String uploadFile(String group_name, byte[] file_buff, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
     ...
     * return null if fail
     */
    public String uploadFile(String group_name, long file_size,
     ...
     * return null if fail
     */
    public String uploadAppenderFile(String local_filename, String file_ext_name,
                                     NameValuePair[] meta_list) throws IOException, MyException {
     ...
     * return null if fail
     */
    public String uploadAppenderFile(byte[] file_buff, String file_ext_name,
                                     NameValuePair[] meta_list) throws IOException, MyException {
     ...
     * return null if fail
     */
    public String uploadAppenderFile(String group_name, long file_size,
                                     UploadCallback callback, String file_ext_name,
                                     NameValuePair[] meta_list) throws IOException, MyException {
     ...
     * return null if fail
     */
    public String uploadFile(String master_file_id, String prefix_name,
                             String local_filename, String file_ext_name, NameValuePair[] meta_list) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(master_file_id, parts);
        if (this.errno != 0) {
            return null;
        }
     ...
     * return null if fail
     */
    public String uploadFile(String master_file_id, String prefix_name, long file_size,
                             UploadCallback callback, String file_ext_name,
                             NameValuePair[] meta_list) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(master_file_id, parts);
  ...
  public String uploadStream(String group_name,
    ...
    String[] parts = this.uploadInputStream(cmd, group_name, local_filename, file_ext_name, is, length, meta_list);
    if (parts != null) {
      return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
    } else {
      return null;
  ...
  protected String[] uploadInputStream(
          byte cmd, String group_name, String local_filename, String file_ext_name,
          InputStream is, long length,
          NameValuePair[] meta_list) throws IOException, MyException {
    ...
    try {
      return this.do_upload_file(cmd, group_name, null, null, file_ext_name,
              length, new UploadStream(is, length), meta_list);
    } finally {
      is.close();
    }
  }
     ...
     */
    public int appendFile(String appender_file_id, String local_filename) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
        }
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int appendFile(String appender_file_id, byte[] file_buff) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int appendFile(String appender_file_id, byte[] file_buff, int offset, int length) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int appendFile(String appender_file_id, long file_size, UploadCallback callback) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 for success, != 0 for error (error no)
     */
    public int modifyFile(String appender_file_id,
    ...
    public int deleteFile(String file_id) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
        }
     ...
     * @return 0 for success, none zero for fail (error code)
     */
    public int truncateFile(String appender_file_id, long truncated_file_size) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(appender_file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int downloadFile(String file_id, long file_offset, long download_bytes, String local_filename) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int downloadFile(String file_id, DownloadCallback callback) throws IOException, MyException {
        final long file_offset = 0;
        final long download_bytes = 0;

        return this.downloadFile(file_id, file_offset, download_bytes, callback);
    }
     ...
     * @return 0 success, return none zero errno if fail
     */
    public int downloadFile(String file_id, long file_offset, long download_bytes, DownloadCallback callback) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public int setMetadata(String file_id, NameValuePair[] meta_list, byte op_flag) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(file_id, parts);
        if (this.errno != 0) {
            return this.errno;
     ...
     */
    public FileInfo queryFileInfo(String file_id) throws IOException, MyException {
        String[] parts = new String[2];
        this.errno = splitFileId(file_id, parts);
        if (this.errno != 0) {
            return null;
