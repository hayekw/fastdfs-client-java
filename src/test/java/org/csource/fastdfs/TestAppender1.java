    ...
    public static void main(String args[]) {
      ...
      storageServer = tracker.getStoreStorage(trackerServer);
  		...
  		*/
            ...
            appender_file_id = client.uploadAppenderFile(file_buff, "txt", meta_list);
  		...
  		*/
            if (appender_file_id == null) {
                ...
                System.err.println(client.getFileInfo(appender_file_id));
                ...
                startTime = System.currentTimeMillis();
                errno = client.setMetadata(appender_file_id, meta_list, ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE);
                ...
                meta_list = client.getMetadata(appender_file_id);
                if (meta_list != null) {
                ...
                startTime = System.currentTimeMillis();
                file_buff = client.downloadFile(appender_file_id);
                ...
                file_ext_name = "txt";
                startTime = System.currentTimeMillis();
                errno = client.appendFile(appender_file_id, file_buff);
                ...
                startTime = System.currentTimeMillis();
                errno = client.deleteFile(appender_file_id);
            ...
            appender_file_id = client.uploadAppenderFile(local_filename, null, meta_list);
            if (appender_file_id != null) {
                int ts;
                String token;
                String file_url;
                ...
                errno = client.downloadFile(appender_file_id, 0, 0, "c:\\" + appender_file_id.replaceAll("/", "_"));
                if (errno == 0) {
                ...
                errno = client.downloadFile(appender_file_id, 0, 0, new DownloadFileWriter("c:\\" + appender_file_id.replaceAll("/", "-")));
                if (errno == 0) {
                    System.err.println("Download file success");
                } else {
                    System.err.println("Download file fail, error no: " + errno);
                ...
                file_ext_name = null;
                startTime = System.currentTimeMillis();
                errno = client.appendFile(appender_file_id, local_filename);
                System.out.println("append_file time used: " + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
                    System.err.println(client.getFileInfo(appender_file_id));
                } else {
            ...
            appender_file_id = client.uploadAppenderFile(null, f.length(),
                    new UploadLocalFileSender(local_filename), file_ext_name, meta_list);
            if (appender_file_id != null) {
                System.out.println(client.getFileInfo(appender_file_id));

                startTime = System.currentTimeMillis();
                errno = client.appendFile(appender_file_id, f.length(), new UploadLocalFileSender(local_filename));
                System.out.println("append_file time used: " + (System.currentTimeMillis() - startTime) + " ms");
                if (errno == 0) {
                    System.err.println(client.getFileInfo(appender_file_id));
                } else {
                ...
                startTime = System.currentTimeMillis();
                errno = client.modifyFile(appender_file_id, 0, f.length(), new UploadLocalFileSender(local_filename));
                ...
                startTime = System.currentTimeMillis();
                errno = client.truncateFile(appender_file_id, 0);
